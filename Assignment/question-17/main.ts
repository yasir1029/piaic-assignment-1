...
console.log('\n I am sorry, the dinner table wont arrive in time, so i can only invite two people. \n');

console.log(guest_list[5]+', Iam sorry you dont have to come to dinner, maybe next time.');
guest_list.pop();
console.log(guest_list[4]+', Iam sorry you dont have to come to dinner, maybe next time.');
guest_list.pop();
console.log(guest_list[3]+', Iam sorry you dont have to come to dinner, maybe next time.');
guest_list.pop();
console.log(guest_list[2]+', Iam sorry you dont have to come to dinner, maybe next time.');
guest_list.pop();
...
console.log('My guest List : '+guest_list);
